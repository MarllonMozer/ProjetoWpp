...
import com.marllonprogramming.projetowpp.adapter.ConversasAdapter
import com.marllonprogramming.projetowpp.databinding.FragmentConversasBinding
                ...
                .addSnapshotListener { querySnapshot, error ->
                    ...
                    documentos?.forEach { documentSnapshot ->
                        ...
                        if(conversa != null){
                            ...
                            Log.i("exibir_conversas","Conversa: ${conversa.nome} - ${conversa.ultimaMensagem}")
                        }
                    }
